<html>
<head>
	<meta http-equiv="Content-Type" content="text/html;charset=utf8mb4_bin">
	...
	<div id="mainFrame">
		<div id="menu" class="floatR">
			<ul>
				...
				<li>
					<a href="Hindi_Jokes.php" class="activeTab" >Hindi Jookes</a>
				</li>
				<li>
...
$sql = "SELECT id, Value FROM hindi_jokes order by id desc";
